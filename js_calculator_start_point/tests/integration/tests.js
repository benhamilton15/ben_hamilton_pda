...
describe('calculator functionality', function() {
  ...
  it('should update the display with pressed numbers', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
    element(by.css('#number1')).click();
    element(by.css('#number8')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('118')
  })

  it('should update the display with result of arithmetic operation', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
